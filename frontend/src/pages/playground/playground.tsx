...
export const GroundPage: React.FC = () => {
  const [query, setQuery] = useState<string>("-- Welcome to SQL Playground\n-- Try: SELECT * FROM Customers LIMIT 5;");
  ...
  const handleReset = (): void => {
    setQuery("-- Welcome to SQL Playground\n-- Try: SELECT * FROM Customers LIMIT 5;");
    setResult(null);
    setIsRunning(false);
  };
        ...
        {leftPanelVisible && (
          <>
            ...
            >
              ...
              <SchemaBrowser dbReady={dbReady} />
            </div>
            <div
              onMouseDown={startDraggingLeft}
              className="w-1 bg-black/5 hover:bg-[#E67350]/30 cursor-col-resize flex-shrink-0 transition-colors group relative"
            >
